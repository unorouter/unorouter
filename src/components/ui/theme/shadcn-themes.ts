...
const THEMES: ShadcnTheme[] = [
  ...
  },
  {
    ...
    cssVars: {
      light: {
        background: "oklch(0.972 0.018 350)",
        foreground: "oklch(0.32 0.06 350)",
        card: "oklch(0.962 0.026 348)",
        "card-foreground": "oklch(0.32 0.06 350)",
        popover: "oklch(0.97 0.024 348)",
        "popover-foreground": "oklch(0.32 0.06 350)",
        primary: "oklch(0.74 0.13 350)",
        "primary-foreground": "oklch(0.99 0.008 350)",
        secondary: "oklch(0.92 0.04 345)",
        "secondary-foreground": "oklch(0.36 0.07 350)",
        muted: "oklch(0.93 0.032 346)",
        "muted-foreground": "oklch(0.56 0.08 350)",
        accent: "oklch(0.9 0.06 340)",
        "accent-foreground": "oklch(0.36 0.07 350)",
        destructive: "oklch(0.577 0.245 27.325)",
        border: "oklch(0.89 0.04 346)",
        input: "oklch(0.9 0.04 346)",
        ring: "oklch(0.74 0.13 350)",
        "chart-1": "oklch(0.85 0.08 348)",
        "chart-2": "oklch(0.74 0.13 350)",
        "chart-3": "oklch(0.66 0.16 354)",
        "chart-4": "oklch(0.58 0.18 358)",
        "chart-5": "oklch(0.5 0.16 2)",
        radius: "0.875rem",
        sidebar: "oklch(0.95 0.03 347)",
        "sidebar-foreground": "oklch(0.34 0.06 350)",
        "sidebar-primary": "oklch(0.74 0.13 350)",
        "sidebar-primary-foreground": "oklch(0.99 0.008 350)",
        "sidebar-accent": "oklch(0.9 0.06 340)",
        "sidebar-accent-foreground": "oklch(0.36 0.07 350)",
        "sidebar-border": "oklch(0.89 0.04 346)",
        "sidebar-ring": "oklch(0.74 0.13 350)",
      },
      dark: {
        background: "oklch(0.235 0.035 345)",
        foreground: "oklch(0.95 0.02 345)",
        card: "oklch(0.285 0.04 345)",
        "card-foreground": "oklch(0.95 0.02 345)",
        popover: "oklch(0.285 0.04 345)",
        "popover-foreground": "oklch(0.95 0.02 345)",
        primary: "oklch(0.8 0.12 348)",
        "primary-foreground": "oklch(0.22 0.05 345)",
        secondary: "oklch(0.34 0.05 344)",
        "secondary-foreground": "oklch(0.95 0.02 345)",
        muted: "oklch(0.32 0.045 344)",
        "muted-foreground": "oklch(0.78 0.06 346)",
        accent: "oklch(0.38 0.07 342)",
        "accent-foreground": "oklch(0.95 0.02 345)",
        destructive: "oklch(0.704 0.191 22.216)",
        border: "oklch(1 0 0 / 12%)",
        input: "oklch(1 0 0 / 16%)",
        ring: "oklch(0.8 0.12 348)",
        "chart-1": "oklch(0.85 0.08 348)",
        "chart-2": "oklch(0.74 0.13 350)",
        "chart-3": "oklch(0.66 0.16 354)",
        "chart-4": "oklch(0.58 0.18 358)",
        "chart-5": "oklch(0.5 0.16 2)",
        sidebar: "oklch(0.27 0.04 345)",
        "sidebar-foreground": "oklch(0.95 0.02 345)",
        "sidebar-primary": "oklch(0.8 0.12 348)",
        "sidebar-primary-foreground": "oklch(0.22 0.05 345)",
        "sidebar-accent": "oklch(0.38 0.07 342)",
        "sidebar-accent-foreground": "oklch(0.95 0.02 345)",
        "sidebar-border": "oklch(1 0 0 / 12%)",
        "sidebar-ring": "oklch(0.8 0.12 348)",
      },
    },
  },
  {
    ...
    cssVars: {
      light: {
        primary: "oklch(0.78 0.12 350)",
        "primary-foreground": "oklch(0.99 0.008 350)",
        secondary: "oklch(0.93 0.045 330)",
        "secondary-foreground": "oklch(0.34 0.07 350)",
        "chart-1": "oklch(0.86 0.08 348)",
        "chart-2": "oklch(0.78 0.12 350)",
        "chart-3": "oklch(0.7 0.15 340)",
        "chart-4": "oklch(0.62 0.17 330)",
        "chart-5": "oklch(0.55 0.16 318)",
        "sidebar-primary": "oklch(0.78 0.12 350)",
        "sidebar-primary-foreground": "oklch(0.99 0.008 350)",
      },
      dark: {
        primary: "oklch(0.82 0.11 348)",
        "primary-foreground": "oklch(0.22 0.05 345)",
        secondary: "oklch(0.35 0.06 332)",
        "secondary-foreground": "oklch(0.95 0.02 345)",
        "chart-1": "oklch(0.86 0.08 348)",
        "chart-2": "oklch(0.78 0.12 350)",
        "chart-3": "oklch(0.7 0.15 340)",
        "chart-4": "oklch(0.62 0.17 330)",
        "chart-5": "oklch(0.55 0.16 318)",
        "sidebar-primary": "oklch(0.82 0.11 348)",
        "sidebar-primary-foreground": "oklch(0.22 0.05 345)",
      },
    },
  },
...
export const ICON_LIBRARIES: IconLibraryOption[] = [
  ...
  { name: "remix", label: "Remix Icon" },
  { name: "iconoir", label: "Iconoir" },
];

export type MenuOption = { name: string; label: string };
export const MENUS: MenuOption[] = [
  { name: "default", label: "Default / Solid" },
  { name: "inverted", label: "Inverted / Solid" },
  { name: "default-translucent", label: "Default / Translucent" },
  { name: "inverted-translucent", label: "Inverted / Translucent" },
];

export const MENU_ACCENTS: MenuOption[] = [
