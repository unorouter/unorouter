...
import { FAR_FUTURE } from "@/lib/config/constants";
    ...
    // The upstream quota-dates payload exceeds the Next data cache 2MB item limit, so PUBLIC_CACHE silently never stored it and every hit refetched the full dump. Cache the computed summary in-module instead.
