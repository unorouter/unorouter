    // exampleMessages string into role-tagged few-shot turns. <START> separates blocks; {{char}}:/{{user}}: prefix lines, bare lines continue the turn. Caller macro-expands.
