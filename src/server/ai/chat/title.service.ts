...
// Stateless; client persists. No DB read or write. preferredModel is ignored: titles are always
// generated by the pinned TITLE_MODELS (English-native, reliable) so they never drift in language.
