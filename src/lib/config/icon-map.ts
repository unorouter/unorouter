    // Per-icon dynamic loaders; each icon enters the chunk graph only on first render. Missing lib key falls back to lucide. GENERATED by scripts/generate-icon-map.ts; edit that script and re-run, not entries here.
