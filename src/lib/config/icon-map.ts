    // Per-icon dynamic loaders; each enters the chunk graph on first render, missing key falls back to lucide. GENERATED by scripts/generate-icon-map.ts; edit the script, not here.
