...
// RequestBody comes in TWO shapes: most models put params on `properties`,
// others (flux-2-flex) nest them under `items.properties`.
...
export function distillSchema(raw: unknown): ModelParamSpec | null {
  ...
  // providerSettings nests one object per vendor, flattened to "<vendor>.<field>".
