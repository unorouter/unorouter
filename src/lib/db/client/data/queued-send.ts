...
export type UnansweredTurn = { convId: string; parentId: string };
    ...
    // "Queued" badge detection: active-branch leaf is a user message with no active child or later active sibling. Detection only, no auto-replay (Risu semantics); self-dedups once the assistant child lands.
